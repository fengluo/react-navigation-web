...
import { Picker, DatePicker, List, Checkbox, Icon } from 'antd-mobile';
...
class Demo extends React.Component {
  static navigationOptions = {
    title: '我的账户',
    tabBarLabel: '我的',
    tabBarIcon: (<Icon type={require('../icons/my.svg')} />)
  }
  ...
  componentWillMount(){
    console.log('will mount 3')
  }
  componentDidMount() {
    console.log('dis mount 3')
    // this.props.changeTitle('朋友');
  }
  render() {
    console.log('renader 3')
